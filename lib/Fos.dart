...
class Fos extends StatefulWidget {
  const Fos({super.key});

  @override
  State<Fos> createState() => _COMPState();
}

class _COMPState extends State<Fos> {
  final commoncolor = Colors.pink[800];
  final List<Subject> sub = [
    Subject('FOS_2015.pdf', '2015', 'https://czmgbca.oshwaleducationtrust.org/papers/PHP%202015.pdf'),
    Subject('FOS_2016.pdf', '2016', 'https://czmgbca.oshwaleducationtrust.org/papers/PHP%202016.pdf'),
    Subject('FOS_2017.pdf', '2017', 'https://czmgbca.oshwaleducationtrust.org/papers/PHP%202017.pdf'),
  ];

...
class _COMPState extends State<COMP> {
  ...
  final List<Subject> sub = [
    Subject('COMP_2015.pdf', '2015', 'https://czmgbca.oshwaleducationtrust.org/papers/Prog.in%20C%202015.pdf'),
    Subject('COMP_2016.pdf', '2016', 'https://czmgbca.oshwaleducationtrust.org/papers/Prog.in%20c%202016.pdf'),
    Subject('COMP_2017.pdf', '2017', 'https://czmgbca.oshwaleducationtrust.org/papers/Prog.in%20C%202017.pdf'),
  ];
          ...
          child: Padding(
            ...
            child: GridView.builder(
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisSpacing: 40.0,  // Reduce the mainAxisSpacing to fit better
              ),

...
class statistical extends StatefulWidget {
  ...
  @override
  State<statistical> createState() => _COMPState();
}

class _COMPState extends State<statistical> {
  final commoncolor = Colors.pink[800];
  final List<Subject> sub = [
    Subject('Statistical_2015.pdf', '2015', 'https://czmgbca.oshwaleducationtrust.org/papers/Java%202015.pdf'),
    Subject('Statistical_2016.pdf', '2016', 'https://czmgbca.oshwaleducationtrust.org/papers/java%202016.pdf'),
    Subject('Statistical_2017.pdf', '2017', 'https://czmgbca.oshwaleducationtrust.org/papers/Java%202017.pdf'),
  ];

...
class Oocp extends StatefulWidget {
  const Oocp({super.key});

  @override
  State<Oocp> createState() => _COMPState();
}

class _COMPState extends State<Oocp> {
  final commoncolor = Colors.pink[800];
  final List<Subject> sub = [
    Subject('OOCP_2015.pdf', '2015', 'https://czmgbca.oshwaleducationtrust.org/papers/C%20Plus%20Plus%202015%20May.pdf'),
    Subject('OOCP_2016.pdf', '2016', 'https://czmgbca.oshwaleducationtrust.org/papers/C%20Plus%20Plus%202016.pdf'),
    Subject('OOCP_2017.pdf', '2017', 'https://czmgbca.oshwaleducationtrust.org/papers/C%20Plus%20Plus%202017.pdf'),
  ];
